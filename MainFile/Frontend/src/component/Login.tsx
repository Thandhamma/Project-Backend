...
const Login: React.FC<LoginModalProps> = ({ isOpen, onClose, onLoginSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 bg-transparent flex items-center justify-center z-50"> {/* 6. แก้ bg-opacity ตามที่ชอบ */}
